...
! function(a, b) {
    ...
    function fb(a) {
        ...
        if (b = a._i.replace(/\([^\)]*\)|[\n\t]/g, " ").replace(/(\s\s+)/g, " ").replace(/^\s|\s$/g, ""), c = Ne.exec(b)) {
            if (d = c[1] ? "ddd" + (5 === c[1].length ? ", " : " ") : "", e = "D MMM " + (c[2].length > 10 ? "YYYY " : "YY "), f = "HH:mm" + (c[4] ? ":ss" : ""), c[1]) {
                var l = new Date(c[2]),
                    m = ["شنبه", "یکشنبه", "دوشنبه", "سه شنبه", "چهرشنبه", "پنجشنبه", "جمعه"][l.getDay()];
    ...
    var oe = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
        pe = "فروردین_اردیبهشت_خرداد_تیر_مرداد_شهریور_مهر_آبان_آذر_دی_بهمن_اسفند".split("_"),
        qe = "فروردین_اردیبهشت_خرداد_تیر_مرداد_شهریور_مهر_آبان_آذر_دی_بهمن_اسفند".split("_"),
        re = be,
        se = be;
    U("Y", 0, 0, function() {
        var a = this.year();
    ...
    var ve = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
        we = "شنبه_یکشنبه_دوشنبه_سه شنبه_چهارشنبه_پنج شنبه_جمعه".split("_"),
